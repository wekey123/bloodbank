...
$result=mysqli_query($con,"SELECT * FROM blood_req");
?>
...
<body>
<div class="header">
<div class="menu"> <div class="top">&nbsp;&nbsp;Home &gt; <a href="admin.php">Admin</a> &gt;Blood Request List</div>
<br /><br /><br /><br /><br /><br />
